                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form action="insert.php" method="post">
                                    <h2>Pokemon Registration Form</h2>
                                    <hr>
                                    <div class="sub-entry">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="confirm" id="confirm" placeholder="Re-enter password..." class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="sub-entry">
                                        <div>
                                            <i>
                                                <h6>Already have an account? <a href="login.php" style="text-decoration:none">Log-in</a>
                                            </i></h6>
                                        </div>
                                    </div>
                                    <div class="mb-3">
